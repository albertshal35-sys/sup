...
INSERT INTO entities (id, kind, name, state, formation_date, registered_agent, principal_name, flips_36mo, avg_margin_pct, avg_hold_days, volume_36mo, velocity_score) VALUES
  ('ent_01','llc','SUNBELT EQUITY GROUP LLC','AZ','2019-03-11','Cogency Global','Marcus Delgado',14,21.4,127,6840000,91),
  ('ent_02','llc','IRONWOOD DEVELOPMENT PARTNERS LLC','TX','2017-08-02','CT Corporation','Priya Raman',9,18.2,164,9120000,84),
  ('ent_03','individual','DANIEL OKAFOR','TX',NULL,NULL,'Daniel Okafor',11,24.8,98,4210000,88),
  ('ent_04','llc','CANYON GATE HOLDINGS LLC','AZ','2021-01-19','Registered Agents Inc','Sofia Anand',6,15.1,143,3380000,72),
  ('ent_05','llc','BLUE HERON BUILDERS LLC','FL','2016-05-27','NW Registered Agent','Tom Kowalski',17,19.7,151,11260000,89),
  ('ent_06','llc','MESA VERDE CAPITAL LLC','AZ','2020-11-03','Cogency Global','Elena Vasquez',8,22.3,112,3970000,81),
  ('ent_07','llc','LONE STAR URBAN INFILL LLC','TX','2018-02-14','CT Corporation','James Whitfield',5,17.9,201,7450000,69),
  ('ent_08','individual','GRACE LIU','FL',NULL,NULL,'Grace Liu',7,26.1,89,2890000,86),
  ('ent_09','llc','PALMETTO RIDGE VENTURES LLC','FL','2022-06-08','Sunshine Corporate Filings','Andre Boyd',4,13.4,177,2140000,58),
  ('ent_10','llc','COPPER STATE RESTORATIONS LLC','AZ','2019-09-30','Registered Agents Inc','Nina Petrov',12,20.6,119,5530000,87);
...
INSERT INTO contacts (id, entity_id, name, title, phone, email, linkedin, source, confidence, verified_at) VALUES
  ('con_01','ent_01','Marcus Delgado','Managing Member','(480) 555-0134','marcus@sunbeltequity.com','linkedin.com/in/marcusdelgado-re','skip_trace',0.94,date('now','-12 days')),
  ('con_02','ent_02','Priya Raman','Principal','(512) 555-0182','praman@ironwooddev.com','linkedin.com/in/priyaraman-dev','skip_trace',0.91,date('now','-30 days')),
  ('con_03','ent_03','Daniel Okafor',NULL,'(214) 555-0197','d.okafor@gmail.com',NULL,'skip_trace',0.88,date('now','-8 days')),
  ('con_04','ent_04','Sofia Anand','Managing Member','(602) 555-0121','sofia@canyongate.co',NULL,'sos_filing',0.79,NULL),
  ('con_05','ent_05','Tom Kowalski','Owner','(305) 555-0158','tom@blueheronbuild.com','linkedin.com/in/tomkowalski-fl','skip_trace',0.96,date('now','-5 days')),
  ('con_06','ent_06','Elena Vasquez','Managing Member','(480) 555-0176','elena@mesaverdecap.com',NULL,'skip_trace',0.85,date('now','-19 days')),
  ('con_07','ent_07','James Whitfield','Principal','(737) 555-0110','jw@lonestarinfill.com','linkedin.com/in/jwhitfield-atx','permit',0.82,NULL),
  ('con_08','ent_08','Grace Liu',NULL,'(813) 555-0143','grace.liu.re@gmail.com',NULL,'skip_trace',0.9,date('now','-3 days')),
  ('con_09','ent_09','Andre Boyd','Managing Member','(904) 555-0129','andre@palmettoridge.io',NULL,'sos_filing',0.74,NULL),
  ('con_10','ent_10','Nina Petrov','Owner','(520) 555-0165','nina@copperstate.build','linkedin.com/in/ninapetrov-az','skip_trace',0.93,date('now','-15 days'));

-- ---------- Properties ----------
INSERT INTO properties (id, apn, address, city, county, state, zip, property_type, beds, baths, sqft, year_built, est_value) VALUES
  ('prp_01','173-24-091','4482 E Cactus Wren Rd','Phoenix','Maricopa','AZ','85018','sfr',4,3,2450,1978,912000),
  ('prp_02','215-06-330','1917 Ryan Dr','Austin','Travis','TX','78704','sfr',3,2,1710,1962,748000),
  ('prp_03','118-51-207','7809 N 13th Pl','Phoenix','Maricopa','AZ','85020','sfr',5,3.5,3120,1989,1130000),
  ('prp_04','402-88-014','2205 Webberville Rd','Austin','Travis','TX','78702','multi',8,8,6400,2024,2850000),
  ('prp_05','30-3129-004','1174 NW 52nd St','Miami','Miami-Dade','FL','33127','sfr',3,2,1440,1954,517000),
  ('prp_06','173-09-556','6033 E Calle Del Paisano','Scottsdale','Maricopa','AZ','85251','sfr',4,4,3380,2001,1620000),
  ('prp_07','051-77-102','912 Vargas Rd','Austin','Travis','TX','78741','sfr',3,1,1180,1958,442000),
  ('prp_08','A-1902-88','3316 W San Miguel Ave','Tampa','Hillsborough','FL','33629','sfr',5,4,3890,2025,2210000),
  ('prp_09','133-18-440','2247 W Berridge Ln','Phoenix','Maricopa','AZ','85015','sfr',3,2,1560,1971,486000),
  ('prp_10','215-44-019','5501 Woodrow Ave','Austin','Travis','TX','78756','sfr',4,3,2280,2024,1390000),
  ('prp_11','30-4411-233','842 NE 82nd Ter','Miami','Miami-Dade','FL','33138','multi',6,6,4820,2025,1980000),
  ('prp_12','162-30-078','4108 N 36th St','Phoenix','Maricopa','AZ','85018','sfr',3,2,1820,1965,689000),
  ('prp_13','097-25-611','1605 E Weber Dr','Tempe','Maricopa','AZ','85281','sfr',4,2,1950,1974,538000),
  ('prp_14','B-2277-13','5214 S MacDill Ave','Tampa','Hillsborough','FL','33611','sfr',3,2,1610,1959,472000);
...
INSERT INTO loans (id, property_id, entity_id, lender_name, lender_type, principal, rate_pct, originated_at, term_months, maturity_date, status) VALUES
  ...
  ('lon_02','prp_03','ent_10','Desert Peak Funding','private',742000,10.75,date('now','-9 months','-19 days'),12,date('now','+2 months','+11 days'),'active'),
  ('lon_03','prp_02','ent_03','Hill Country Note Co','hard_money',505000,11.9,date('now','-8 months','-11 days'),12,date('now','+3 months','+19 days'),'active'),
  ...
  ('lon_05','prp_05','ent_08','Gulfstream Private Lending','private',352000,12.1,date('now','-8 months','-27 days'),12,date('now','+3 months','+3 days'),'active'),
  ('lon_06','prp_07','ent_07','Hill Country Note Co','hard_money',298000,11.5,date('now','-9 months','-2 days'),12,date('now','+2 months','+28 days'),'active'),
  ('lon_07','prp_09','ent_04','Desert Peak Funding','private',331000,10.9,date('now','-10 months','-8 days'),12,date('now','+1 months','+22 days'),'active'),
  ...
  ('lon_09','prp_13','ent_10','Desert Peak Funding','private',365000,10.5,date('now','-17 months'),12,date('now','-5 months'),'paid_off'),
  ('lon_10','prp_14','ent_05','Gulfstream Private Lending','private',312000,11.75,date('now','-14 months'),12,date('now','-2 months'),'refinanced');
...
INSERT INTO transactions (id, property_id, entity_id, side, price, is_cash, deed_type, buyer_name, seller_name, recorded_at) VALUES
  ...
  ('trx_01','prp_04','ent_02','purchase',1410000,1,'special_warranty','IRONWOOD DEVELOPMENT PARTNERS LLC','ESTATE OF R MARTIN',date('now','-41 days')),
  ('trx_02','prp_10','ent_02','purchase',866000,1,'warranty','IRONWOOD DEVELOPMENT PARTNERS LLC','KELLER 1990 TRUST',date('now','-26 days')),
  ('trx_03','prp_07','ent_02','purchase',401000,1,'warranty','IRONWOOD DEVELOPMENT PARTNERS LLC','VARGAS FAMILY LP',date('now','-9 days')),
  ...
  ('trx_08','prp_12','ent_01','purchase',521000,0,'warranty','SUNBELT EQUITY GROUP LLC','PRIVATE SELLER',date('now','-22 months')),
  ('trx_09','prp_12','ent_01','sale',689000,0,'warranty','OWNER OCCUPANT','SUNBELT EQUITY GROUP LLC',date('now','-15 months')),
  ('trx_10','prp_01','ent_01','purchase',655000,0,'warranty','SUNBELT EQUITY GROUP LLC','ESTATE SALE',date('now','-9 months','-6 days')),
  ('trx_11','prp_09','ent_04','purchase',389000,0,'warranty','CANYON GATE HOLDINGS LLC','HUD',date('now','-10 months','-8 days')),
  ('trx_12','prp_03','ent_10','purchase',818000,0,'warranty','COPPER STATE RESTORATIONS LLC','RELOCATION CO',date('now','-9 months','-19 days'));
...
INSERT INTO permits (id, property_id, entity_id, permit_no, permit_type, description, valuation, filed_at, status, contractor) VALUES
  ('pmt_01','prp_04','ent_02','2026-BP-18834','ground_up','New 8-unit multifamily, 3-story, 6,400 sqft','2350000',date('now','-11 days'),'in_review','Ironwood Development (owner-builder)'),
  ...
  ('pmt_03','prp_06','ent_06','2026-BP-17501','structural','Full gut: remove 2 bearing walls, new steel beam, 900 sqft addition','487000',date('now','-15 days'),'issued','Mesa Verde Capital (GC: Sunline Const.)'),
  ...
  ('pmt_05','prp_10','ent_07','2026-BP-19112','structural','Second-story addition + foundation underpinning','362000',date('now','-4 days'),'filed','Lone Star Urban Infill LLC');
...
INSERT INTO triggers (id, kind, entity_id, property_id, ref_id, score, urgency, headline, payload_json, detected_at, status) VALUES
  ('trg_01','maturity','ent_04','prp_09','lon_07',94,'critical','Note matures in ~52 days — originated 10 mo ago with Desert Peak','{"principal":331000,"lender":"Desert Peak Funding","rate":10.9,"daysToMaturity":52}',datetime('now','-1 days'),'new'),
  ...
  ('trg_03','maturity','ent_10','prp_03','lon_02',88,'hot','12-mo private note at 10.75% enters month 10 next week','{"principal":742000,"lender":"Desert Peak Funding","rate":10.75,"daysToMaturity":71}',datetime('now','-2 days'),'new'),
  ...
  ('trg_05','maturity','ent_07','prp_07','lon_06',79,'hot','Bridge note month 9 of 12; permit activity suggests project mid-flight','{"principal":298000,"lender":"Hill Country Note Co","rate":11.5,"daysToMaturity":88}',datetime('now','-3 days'),'new'),
  ('trg_06','maturity','ent_03','prp_02','lon_03',77,'warm','High-margin flipper in month 8; refi window opening','{"principal":505000,"lender":"Hill Country Note Co","rate":11.9,"daysToMaturity":109}',datetime('now','-2 days'),'new'),
  ('trg_07','maturity','ent_08','prp_05','lon_05',74,'warm','12.1% private note in month 8 — rate-relief refi candidate','{"principal":352000,"lender":"Gulfstream Private Lending","rate":12.1,"daysToMaturity":93}',datetime('now','-4 days'),'new'),
  ...
  ('trg_16','lien','ent_06','prp_06','lin_01',91,'critical','$148.5K GC lien on Scottsdale gut reno; note matures in ~57 days','{"amount":148500,"claimant":"Sunline Construction Inc"}',datetime('now','-1 days'),'new'),
