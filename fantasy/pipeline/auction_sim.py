    ...
    for ns in range(14):
        ...
        for rot in range(12):
            ...
            for t in range(TEAMS):
                ...
                sc[t] = optimal_weekly(posv[ix], poolmat[ix])
            wins = np.zeros(TEAMS)
            for w in range(17):
                c = sc[:, w]
...
json.dump(r.to_dict("records"), open("out/research_auction.json", "w"), indent=1, default=str)
print("wrote out/research_auction.json")
