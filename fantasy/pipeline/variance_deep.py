...
KS = [0.0, -8.0, -14.0, -20.0, -28.0, -40.0]
...
json.dump(r.to_dict("records"), open("out/research_variance_deep.json", "w"), indent=1, default=str)
print("\nwrote out/research_variance_deep.json")
