...
KS = [-10.0, -4.0, 0.0, 4.0, 10.0, 20.0]     # six arms, two teams each
...
print("=" * 78)
print("R. IS CONSISTENCY WORTH PAYING FOR?  —  value = points − k × weekly spread")
print("=" * 78)
obs = {k: [] for k in KS}
for season in ALL:
...
json.dump(r.to_dict("records"), open("out/research_consistency.json", "w"), indent=1, default=str)
print("\nwrote out/research_consistency.json")
